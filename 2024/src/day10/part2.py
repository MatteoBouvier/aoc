...
def compute_rating(trailhead: tuple[int, int], map: list[list[int]]) -> int:
    ...
    while not to_visit.empty():
        ...
        for offset in ((0, -1), (0, 1), (-1, 0), (1, 0)):
            ...
            if in_bounds(new_x, new_y) and map[new_x][new_y] == value + 1:
...
def main() -> int:
    ...
    return sum(compute_rating(trailhead, map) for trailhead in trailheads)
